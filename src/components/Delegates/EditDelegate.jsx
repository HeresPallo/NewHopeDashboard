    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-100 rounded mt-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="email" {...register("email")} className="w-full p-3 border rounded-lg mt-1" />
        ...
        <div>
          ...
          {errors.organname && <p className="text-red-500 text-sm">{errors.organname.message}</p>}
        </div>
